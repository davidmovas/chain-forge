...
var GRPCTxRelay GRPCMsgRelay[chain2.SigTx] = func(
	ctx context.Context, conn *grpc.ClientConn, chRelay chan chain2.SigTx,
) error {
...
var GRPCBlockRelay GRPCMsgRelay[chain2.SigBlock] = func(
	ctx context.Context, conn *grpc.ClientConn, chRelay chan chain2.SigBlock,
) error {
